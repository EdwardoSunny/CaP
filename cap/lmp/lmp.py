...
from cap.lmp.utils import load_prompt, DynamicObservation, IterableDynamicObservation
import time
from cap.lmp.LLM_cache import DiskCache

client = OpenAI()

class LMP:
    """Language Model Program (LMP), adopted from Code as Policies."""
    def __init__(self, name, cfg, fixed_vars, variable_vars, debug=False, env='real'):
        self._name = name
        self._cfg = cfg
        self._debug = debug
